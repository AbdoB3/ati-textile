...
export const productDetailsData = {
  "cuir-synthetique": {
    ...
    imageUrl:
      "https://www.microfiberleather.com/wp-content/uploads/sites/59/2022/04/synthetic-leather.jpg",
    description:
      "Revêtements cuir synthétique et naturel destinés à la fabrication de chaussures, maroquinerie et ameublement.",
    applications: ["Chaussures", "Accesoires cuir", "Meubles & sellerie"],
    specifications: {
      Épaisseur: "1.0mm - 2.2mm",
      Support: "PU / PVC / Microfibre",
      Résistance: "Anti-usure & Anti-humidité",
      Entretien: "Facile",
    },
    details:
  ...
  "tissus-chaussure": {
    ...
    specifications: {
      ...
      Traitements: "Anti-transpiration / Anti-odeur",
  ...
  "accessoires-chaussure": {
    ...
    specifications: {
      ...
      Conditionnement: "Selon besoin",
    },
    details:
      "Solutions professionnelles assurant une fixation durable, adaptées aux lignes de production rapides.",
  },
  ...
  "tissus-ameublement": {
    ...
    specifications: {
      ...
      Nettoyage: "Facile",
      Traitements: "Anti-tâches",
      Textures: "Velours / Jacquard / Uni",
    },
    details:
  ...
  "mousses-industrielles": {
    ...
    imageUrl:
      "https://alcantech.com/cdn/shop/files/S7d15c0a834f54a3194f4075afff1ede05.webp?v=1726353445&width=713",
    description:
      "Mousses techniques pour rembourrage de haute densité adaptées aux sièges et coussins.",
    applications: ["Sièges", "Canapés", "Automobile"],
    specifications: {
      Densité: "18kg à 45kg",
      Confort: "Medium à ferme",
      Découpe: "Sur mesure",
  ...
  "tissus-automobile": {
    ...
    specifications: {
      ...
      Certifications: "Normes automobile",
      Variantes: "Uni / motif",
    },
    details:
